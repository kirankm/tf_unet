    ...
    def _get_cost(self, logits, cost_name, cost_kwargs):
        ...
        if cost_name == "cross_entropy":
            ...
            if class_weights is not None:
                ...
                print ("With class wts",flat_labels.shape, flat_logits.shape,logits.shape, self.y.shape)
                ...
                print ("Without class wts",flat_labels.shape, flat_logits.shape,logits.shape, self.y.shape)
...
class Trainer(object):
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.75, display_step=1, restore=False):
        ...
        saver = tf.train.Saver()
        norm_gradients_val = tf.placeholder(tf.float32)
        assign_op = self.norm_gradients_node.assign(norm_gradients_val)
        ...
        with tf.Session(config=config) as sess:
            ...
            for epoch in range(epochs):
                ...
                for step in range((epoch*training_iters), ((epoch+1)*training_iters)):
                    ...
                    #print(len(norm_gradients))
                    #after4 = datetime.datetime.now()
                    sess.run(assign_op,feed_dict = {norm_gradients_val:norm_gradients})
                    ...
                    #print("the time taken is ", after1- before1, before2 - before1, before3 - before2, after3 - before3,after2 - after3, after1 -after2,after2 - after4)
    ...
    def store_prediction(self, sess, batch_x, batch_y, name):
        ...
        print ("batch shapes are",batch_x.shape, batch_y.shape,util.crop_to_shape(batch_y, pred_shape).shape)
